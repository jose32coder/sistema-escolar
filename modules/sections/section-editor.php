            ...
            <ul>
                <li>
                    <a class="<?php if ($output[1] == 'home') {
                                    echo 'active';
                                } ?>" href="http://localhost/sistema-escolar-main" title="Dashboard"><span class="icon">dashboard</span></a>
                </li>
                <li>
                    <a class="<?php if ($output[1] == 'teachers') {
                                    echo 'active';
                                } ?>" href="http://localhost/sistema-escolar-main/modules/teachers" title="Docentes"><span class="icon">connect_without_contact</span></a>
                </li>
                <li>
                    <a class="<?php if ($output[1] == 'students') {
                                    echo 'active';
                                } ?>" href="http://localhost/sistema-escolar-main/modules/students" title="Alumnos"><span class="icon">recent_actors</span></a>
                </li>
                <li>
                    <a class="<?php if ($output[1] == 'careers') {
                                    echo 'active';
                                } ?>" href="http://localhost/sistema-escolar-main/modules/careers" title="Carreras"><span class="icon">school</span></a>
                </li>
                <li>
                    <a class="<?php if ($output[1] == 'subjects') {
                                    echo 'active';
                                } ?>" href="http://localhost/sistema-escolar-main/modules/subjects" title="Asignaturas"><span class="icon">library_books</span></a>
                </li>
                <li>
                    <a class="<?php if ($output[1] == 'groups') {
                                    echo 'active';
                                } ?>" href="http://localhost/sistema-escolar-main/modules/groups" title="Grupos"><span class="icon">groups</span></a>
                </li>
            </ul>
        </nav>
    </header>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a href="http://localhost/sistema-escolar-main/modules/logout" title="Cerrar Sesión"><span class="icon">logout</span></a>
                </li>
            </ul>
        </nav>
    </header>
