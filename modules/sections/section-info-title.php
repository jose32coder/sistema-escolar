...
$file_1 = $_SESSION['raiz'] . '/modules/sections/role-access-admin-editor.php';

if(file_exists($file_1)) require_once $file_1; else die("NO encontrada");
...
<div class="info-school-period">
    <span class="school-period">
        Periodo Escolar /
        <a id="schoolPeriod" href="http://localhost/sistema-escolar-main/modules/school_periods/"><?php print $_SESSION['school_period']; ?></a>
    </span>
</div>